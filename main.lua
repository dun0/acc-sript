...
local moons = {
	...
	{
		name = "eclipse_moon",
		display = "Eclipse Moon",
		tier = 7
	},
	{
		name = "monarch_moon",
		display = "Monarch Moon",
		tier = 8
	},
	{
		name = "tsukiyomi_moon",
		display = "Tsukiyomi Moon",
		tier = 9
	},
	{
		name = "inferno_moon",
		display = "Inferno Moon",
		tier = 10
	},
	{
		name = "abyss_moon",
...
BossTabButton.MouseButton1Click:Connect(function()
	setActiveTab("Boss")
end)
...
MinimizeButton.MouseButton1Click:Connect(function()
	...
	if not isMinimized then
		...
		if BossTabButton.BackgroundColor3 == Color3.fromRGB(45, 45, 55) then
			BossFrame.Visible = true
		else
			BossFrame.Visible = false
		end
		if MoonTabButton.BackgroundColor3 == Color3.fromRGB(45, 45, 55) then
			...
			if config.enabled then
				...
				for floor, floorData in pairs(config.floors) do
					if floorData.enabled then
						table.insert(floorsToRun, {
							floor = floor,
							teamSlot = floorData.teamSlot or 1
						})
					end
				end
				table.sort(floorsToRun, function(a, b)
